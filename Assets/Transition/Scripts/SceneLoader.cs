...
public class SceneLoader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (fader == null)
        {
            ...
            fader.FadeOut(Settings.TRANSITION_DURATION);
        ...
        if (mixer == null)
        {
            ...
            StartCoroutine(Audio.Fade(mixer, "Master Volume", Settings.TRANSITION_DURATION, Settings.MASTER_VOLUME));
    }
    ...
    public void LoadNextScene() {
        fader.FadeIn(Settings.TRANSITION_DURATION);
        StartCoroutine(Audio.Fade(mixer, "Master Volume", Settings.TRANSITION_DURATION, 0));
        StartCoroutine(LoadSceneAsync(nextScene, Settings.TRANSITION_DURATION));
    }
}
